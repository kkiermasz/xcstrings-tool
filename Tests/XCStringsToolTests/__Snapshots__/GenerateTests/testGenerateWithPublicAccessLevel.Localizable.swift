...
public enum Localizable {
    ...
    public static let myDeviceVariant = resolve(
        LocalizedStringResource(
            "myDeviceVariant",
    ...
    public static func myPlural(_ arg1: Int) -> String {
        resolve(
            LocalizedStringResource(
                "myPlural",
    ...
    public static func mySubstitute(_ arg1: Int, count arg2: Int) -> String {
        resolve(
            LocalizedStringResource(
                "mySubstitute",
