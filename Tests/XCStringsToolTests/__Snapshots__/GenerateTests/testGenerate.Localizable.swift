...
internal enum Localizable {
    /// This is a comment
    internal static let key = resolve(
    ...
    internal static let myDeviceVariant = resolve(
        LocalizedStringResource(
            "myDeviceVariant",
    ...
    internal static func myPlural(_ arg1: Int) -> String {
        resolve(
            LocalizedStringResource(
                "myPlural",
    ...
    internal static func mySubstitute(_ arg1: Int, count arg2: Int) -> String {
        resolve(
            LocalizedStringResource(
                "mySubstitute",
